...
Module['FS_createPath']("/", "res", true, true);
    ...
    loadPackage({"files": [{"filename": "/res/items.xml", "start": 0, "end": 606}], "remote_package_size": 606});

  })();

// end include: /tmp/tmp0eb_vbb5.js
// include: /tmp/tmpnua8o1aj.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpnua8o1aj.js
// include: /tmp/tmp03poo1iv.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp03poo1iv.js
...
var ASM_CONSTS = {
  91086: () => { if (document.fullscreenElement) return 1; },  
 91132: () => { return Module.canvas.width; },  
 91164: () => { return parseInt(Module.canvas.style.width); },  
 91212: () => { document.exitFullscreen(); },  
 91239: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 91311: () => { if (document.fullscreenElement) return 1; },  
 91357: () => { return Module.canvas.width; },  
 91389: () => { return screen.width; },  
 91414: () => { document.exitFullscreen(); },  
 91441: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 91635: () => { return window.innerWidth; },  
 91661: () => { return window.innerHeight; },  
 91688: () => { if (document.fullscreenElement) return 1; },  
 91734: () => { return Module.canvas.width; },  
 91766: () => { return parseInt(Module.canvas.style.width); },  
 91814: () => { if (document.fullscreenElement) return 1; },  
 91860: () => { return Module.canvas.width; },  
 91892: () => { return screen.width; },  
 91917: () => { return window.innerWidth; },  
 91943: () => { return window.innerHeight; },  
 91970: () => { if (document.fullscreenElement) return 1; },  
 92016: () => { return Module.canvas.width; },  
 92048: () => { return screen.width; },  
 92073: () => { document.exitFullscreen(); },  
 92100: () => { if (document.fullscreenElement) return 1; },  
 92146: () => { return Module.canvas.width; },  
 92178: () => { return parseInt(Module.canvas.style.width); },  
 92226: () => { document.exitFullscreen(); },  
 92253: ($0) => { Module.canvas.style.opacity = $0; },  
 92291: () => { return screen.width; },  
 92316: () => { return screen.height; },  
 92342: () => { return window.screenX; },  
 92369: () => { return window.screenY; },  
 92396: () => { return window.devicePixelRatio; },  
 92432: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 92485: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 92536: () => { Module.canvas.style.cursor = 'none'; },  
 92573: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 92829: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 92880: () => { if (document.pointerLockElement) return 1; },  
 92927: () => { if (document.fullscreenElement) return 1; },  
