...
Module['FS_createPath']("/", "res", true, true);
    ...
    loadPackage({"files": [{"filename": "/res/items.xml", "start": 0, "end": 4582}], "remote_package_size": 4582});

  })();

// end include: /tmp/tmpycgcbo7u.js
// include: /tmp/tmpbe5wtxxl.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpbe5wtxxl.js
// include: /tmp/tmpsum1de2r.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpsum1de2r.js
...
var ASM_CONSTS = {
  91150: () => { if (document.fullscreenElement) return 1; },  
 91196: () => { return Module.canvas.width; },  
 91228: () => { return parseInt(Module.canvas.style.width); },  
 91276: () => { document.exitFullscreen(); },  
 91303: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 91375: () => { if (document.fullscreenElement) return 1; },  
 91421: () => { return Module.canvas.width; },  
 91453: () => { return screen.width; },  
 91478: () => { document.exitFullscreen(); },  
 91505: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 91699: () => { return window.innerWidth; },  
 91725: () => { return window.innerHeight; },  
 91752: () => { if (document.fullscreenElement) return 1; },  
 91798: () => { return Module.canvas.width; },  
 91830: () => { return parseInt(Module.canvas.style.width); },  
 91878: () => { if (document.fullscreenElement) return 1; },  
 91924: () => { return Module.canvas.width; },  
 91956: () => { return screen.width; },  
 91981: () => { return window.innerWidth; },  
 92007: () => { return window.innerHeight; },  
 92034: () => { if (document.fullscreenElement) return 1; },  
 92080: () => { return Module.canvas.width; },  
 92112: () => { return screen.width; },  
 92137: () => { document.exitFullscreen(); },  
 92164: () => { if (document.fullscreenElement) return 1; },  
 92210: () => { return Module.canvas.width; },  
 92242: () => { return parseInt(Module.canvas.style.width); },  
 92290: () => { document.exitFullscreen(); },  
 92317: ($0) => { Module.canvas.style.opacity = $0; },  
 92355: () => { return screen.width; },  
 92380: () => { return screen.height; },  
 92406: () => { return window.screenX; },  
 92433: () => { return window.screenY; },  
 92460: () => { return window.devicePixelRatio; },  
 92496: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 92549: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 92600: () => { Module.canvas.style.cursor = 'none'; },  
 92637: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 92893: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 92944: () => { if (document.pointerLockElement) return 1; },  
 92991: () => { if (document.fullscreenElement) return 1; },  
 93037: () => { return window.innerWidth; },  
 93063: () => { return window.innerHeight; }
};
